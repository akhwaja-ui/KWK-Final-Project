            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                DisclosureGroup("Girls Who Code (GWC)", isExpanded: $isExpanded1) {
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        Text("Who")
                            .fontWeight(.bold)
                        Text("GWC offers after-school clubs that are meant for girls in grades 3–5 and 6–12 that teach computer science skills like coding basics and mobile app development. They also have the Summer Immersion program that assists high school girls in learning computer science skills.")
                            .fontWeight(.light)
                            .padding()
                            .background(Color.blue.opacity(0.3))
                            .cornerRadius(10)
                ...
                DisclosureGroup("Google’s Computer Science Summer Institute", isExpanded: $isExpanded2) {
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        Text("Requirements")
                            .fontWeight(.bold)
                        Text("There are no stated requirements, but CSSI searches for high school students that are truly passionate about technology and can withstand an intense and hands-on opportunity for learning the concepts of programming.")
                    }
                    .padding()
                ...
                DisclosureGroup("InspiritAI: Computer Science Summer Program", isExpanded: $isExpanded4) {
                    VStack(alignment: .leading, spacing: 10) {
                        Text("Overview")
                            .fontWeight(.bold)
